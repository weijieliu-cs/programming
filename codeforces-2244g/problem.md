<!--
Canonical URL: https://codeforces.com/problemset/problem/2244/G
Problem ID: 2244G
...
Formally, for any two chosen assignments with indices $i$ and $j$, the following condition must hold: $\vert i - j\vert > \max(a_i, a_j)$.
